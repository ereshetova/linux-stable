...
struct ext4_sb_info {
	...
	stats_t s_bal_reqs;	/* number of reqs with len > 1 */
	stats_t s_bal_success;	/* we found long enough chunks */
	stats_t s_bal_allocated;	/* in blocks */
	stats_t s_bal_ex_scanned;	/* total extents scanned */
	stats_t s_bal_goals;	/* goal hits */
	stats_t s_bal_breaks;	/* too long searches */
	stats_t s_bal_2orders;	/* 2^order hits */
	spinlock_t s_bal_lock;
	unsigned long s_mb_buddies_generated;
	unsigned long long s_mb_generation_time;
	stats_t s_mb_lost_chunks;
	stats_t s_mb_preallocated;
	stats_t s_mb_discarded;
